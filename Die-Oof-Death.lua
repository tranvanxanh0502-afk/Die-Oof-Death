...
local function createSkillButton(skillName)
    ...
    local innerFrame=Instance.new("Frame"); innerFrame.Size=UDim2.new(1,0,1,0); innerFrame.BackgroundColor3=Color3.fromRGB(255,255,255); innerFrame.BackgroundTransparency=0.25; innerFrame.BorderSizePixel=0; innerFrame.Parent=btnFrame
